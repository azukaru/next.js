...
import { OPTIMIZED_FONT_PROVIDERS } from '../lib/constants'
import { cleanAmpPath } from './utils'
...
export class Head extends Component<HeadProps> {
  ...
  makeStylesheetInert(node: React.ReactNode): React.ReactNode[] {
  ...
  render() {
    ...
    return (
      <>
        ...
        {disableOptimizedLoading &&
          !disableRuntimeJS &&
          getPolyfillScripts(this.context, this.props)}
        {disableOptimizedLoading &&
          !disableRuntimeJS &&
          getPreNextScripts(this.context, this.props)}
        {disableOptimizedLoading &&
          !disableRuntimeJS &&
          getDynamicChunks(this.context, this.props, files)}
        {disableOptimizedLoading &&
          !disableRuntimeJS &&
          getScripts(this.context, this.props, files)}
      </>
    )
  }
}
